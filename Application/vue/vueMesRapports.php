...
<div class="container-fluid">
    <!-- Script permettant de masquer le contenu dans le buton "Visualiser/Modifier" -->
     ...
     <a href="#" type="submit" class="btn btn-theme btn-lg2" onclick="showDiv()">Visualiser/Modifier</a><br>
    <!-- Contenui masqué -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-1">
                                 <select name="date_rapport" class="form-select2 form-select-sm" aria-label=".form-select-sm example" required>
                                     <option class="form-control" selected >Sélectionner la date</option>
                ...
                <div class="col-md-12">
                  ...
                  <b>Medicaments offerts: </b><br>
                   ...
                   for($j=0; $j<count($lesOffres); $j++){ ?>
                    <?=$lesOffres[$j]->getQuantite()." ".$lesOffres[$j]->getMedicament()->getNomCommercial()." "?><br>
                   <?php
                   }
                   }
                   else{?>
