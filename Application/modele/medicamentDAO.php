 ...
 // FONCTION QUI PERMET DE CHARGER LES MEDICAMENTS   
    public static function getMedicamentDAO()
    {
        ...
        foreach($ligne as $key => $value){
            ...
            $famille =  medicamentDAO::chargerFamilleMedicament(trim($value['idMedicament']));
 
            $collectionmedicament = new medicament($value['idMedicament'],$value['nomCommercial'], $famille, $value['composition'],$value['effets'],$value['contreIndications']);
   ...
   // FONCTION QUI PERMET DE CHATGER UN MEDICAMENT A PARTIR DE SON IDENTIFIANT
